...
package co.techmagic.inapppurchasesintegrationsample.billing;
...
import co.techmagic.inapppurchasesintegrationsample.activities.BillingActivity;
...
public class IabHelper {
    ...
    public void launchPurchaseFlow(BillingActivity act, String sku, int requestCode, OnIabPurchaseFinishedListener listener) {
        launchPurchaseFlow(act, sku, requestCode, listener, "");
    }

    public void launchPurchaseFlow(BillingActivity act, String sku, int requestCode,
            OnIabPurchaseFinishedListener listener, String extraData) {
        launchPurchaseFlow(act, sku, ITEM_TYPE_INAPP, null, requestCode, listener, extraData);
    }

    public void launchSubscriptionPurchaseFlow(BillingActivity act, String sku, int requestCode,
